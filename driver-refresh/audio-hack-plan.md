...
Goal: a hands-on talk-track piece for the **REDACTED** round (he wrote
drivers) + a demoable **optimization** win for the REDACTED round. Reuses the
...
## Why it scores
- mmap ring + head/tail + lock-free producer/consumer = **exactly REDACTED's domain**
