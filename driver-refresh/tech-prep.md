# VENDER Technical Interview — Embedded C / Linux Kernel Prep Plan
...
### Day 8 — Interrupts, DMA & memory-mapped devices (VENDER bullseye)
...
- 📖 Light HFT domain (20 min, vocabulary only): order book, bid/ask, market-data multicast
  feeds, FIX. The recruiter said domain not required — this is fluency insurance.
